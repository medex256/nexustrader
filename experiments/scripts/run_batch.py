...
def main() -> int:
    ...
    parser.add_argument("--tickers-file", default="", help="Optional file with one ticker per line")
    parser.add_argument("--dates", default="", help="Comma-separated simulated dates (YYYY-MM-DD)")
    parser.add_argument("--dates-file", default="", help="Optional file with one date per line")
    ...
    parser.add_argument("--out", default="nexustrader/experiments/results/raw", help="Output directory")
